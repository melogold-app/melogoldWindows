...
/// «Слушать · Перемешать · Сохранить · …». Описание — три строки, «Ещё» раскрывает целиком.
/// </summary>
